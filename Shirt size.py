...
while True:
    ...
    try:
        ...
        # Calculate distance between camera and user
        if faces:
            face = faces[0]
            pointLeft = face[145]
            pointRight = face[374]
            ...
            if d < 295:
                ...
                if results.pose_landmarks:
                    ...
                    for landmark in [mp_pose.PoseLandmark.LEFT_SHOULDER, mp_pose.PoseLandmark.RIGHT_SHOULDER,
                        ...
                        if landmark == mp_pose.PoseLandmark.LEFT_SHOULDER or landmark == mp_pose.PoseLandmark.RIGHT_SHOULDER:
                            color = (255, 0, 0)  # Blue for shoulders
                        elif landmark == mp_pose.PoseLandmark.LEFT_WRIST or landmark == mp_pose.PoseLandmark.RIGHT_WRIST:
